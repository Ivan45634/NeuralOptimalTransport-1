...
DATASET1, DATASET1_PATH = 'celeba_female', '/gpfs/gpfs0/groznyy.sergey/Datasets/celeba_preprocessed_512_v2'
DATASET2, DATASET2_PATH = 'aligned_anime_faces', '/gpfs/gpfs0/groznyy.sergey/Datasets/anime_preprocessed_512_v2'

batch_scale = 4  # to try linear scaling rule
...
if __name__ == "__main__":
    ...
    f = ResNet_D(size=LATENTS_SIZE, nc=4).cuda()
    f.apply(weights_init_D)

    T = UNet(4, 4, base_factor=48).cuda()
    ...
    for step in tqdm(range(MAX_STEPS)):
        ...
        print(f"Step {step}: Elapsed Time: {elapsed_time} seconds")
        # wandb.log(
        #     {
